...
import { Box, SimpleGrid, Button, Spinner, Flex, Text } from '@chakra-ui/react';
...
const navigate = useNavigate()
  ...
  const isAllDayCompleted = days.every((day) =>
    day.UserDays.every(
      ...
      {isAllDayCompleted && (
        <Button
          ...
          _hover={{
            ...
            boxShadow:
              '0 0 5px #4CAF50, 0 0 25px #4CAF50, 0 0 50px #4CAF50, 0 0 100px #4CAF50',
        ...
        >
          <Text display="flex" alignItems="center" gap={2}>
            Поздравляем вас! Вы завершили план! <FaFlagCheckered />
          </Text>
        </Button>
      )}
    </Flex>
