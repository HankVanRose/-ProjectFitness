  ...
  return (
    ...
    <Card.Root maxW="sm" overflow="hidden">
      <Card.Body gap="5">
        ...
        <Card.Description
          textAlign={'center'}
          style={{ color: isAnyDayCompleted ? 'green' : 'red', fontWeight: 600 }} // Меняем цвет в зависимости от состояния
        >
          {isAnyDayCompleted ? `ТЫ ЗАРАБОТАЛ: ${points} points` : `ТЫ ЗАРАБОТАЕШЬ: ${points} points`} {/* Меняем текст в зависимости от состояния */}
        </Card.Description>
      </Card.Body>
      <Card.Footer
        gap="5"
